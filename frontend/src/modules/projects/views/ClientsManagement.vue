      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="handleFormSubmit" class="space-y-4">
          ...
          <div>
            ...
            <input
              v-model="clientFormData.company"
              type="text"
              class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            />
          </div>
          ...
          <div>
            ...
            <input
              v-model="clientFormData.contact_person"
              type="text"
              required
              class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            />
...
const viewClientDetails = (client: Client) => {
  console.log('View client details:', client.name)
...
const handleFormSubmit = async () => {
  // Basic validation
  if (!clientFormData.value.name || !clientFormData.value.email || !clientFormData.value.phone ||
      !clientFormData.value.contact_person || !clientFormData.value.address) {
