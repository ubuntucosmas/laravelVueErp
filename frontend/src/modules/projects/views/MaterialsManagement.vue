<template>
  <div class="space-y-6">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Materials & Quotation</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Materials & Quotation</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Create material lists and quotations for projects</p>
      </div>
      <button
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-8">
      <div class="text-center">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Materials & Quotation Management</h3>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This feature is under development. Check back soon!</p>
      </div>
    </div>
  </div>
</template>
