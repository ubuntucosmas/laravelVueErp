...
class BudgetController extends Controller
{
    ...
    {
        // Apply read permission to viewing methods
        $this->middleware('permission:' . \App\Constants\Permissions::FINANCE_BUDGET_READ, [
            'only' => ['getBudgetData', 'checkMaterialsUpdate']
        ]);

        // Apply update permission to modification methods
        $this->middleware('permission:' . \App\Constants\Permissions::FINANCE_BUDGET_UPDATE, [
            'only' => ['saveBudgetData', 'submitForApproval', 'importMaterials']
        ]);
    }
